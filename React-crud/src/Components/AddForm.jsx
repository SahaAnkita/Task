    ...
    return (
        <form onSubmit={handleSubmit}>
            <div >
                ...
                <select name="address" value={address} onChange={e => onInputChange(e)}>
            ...
            <Button className="editbtn" variant="success" type="submit">Add New Employee</Button>
        </form>
    )
}
